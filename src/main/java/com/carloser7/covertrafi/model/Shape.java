...
public class Shape {
	...
	public String toString() {
		return "Shape [shape_id=" + shape_id + ", shape_pt_lat=" + shape_pt_lat + ", shape_pt_lon=" + shape_pt_lon
				+ ", shape_pt_sequence=" + shape_pt_sequence + ", shape_dist_traveled=" + shape_dist_traveled + "]";
	}
